...
CREATE TABLE convoy.delivery_attempts_tenant1_20250601
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-01 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-02 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250602
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-02 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-03 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250626
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-26 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-27 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250627
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-27 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-28 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250628
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-28 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-29 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250629
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-29 00:00:00+00'::timestamptz) TO ('tenant1', '2025-06-30 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250630
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-06-30 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-01 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250701
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-07-01 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-02 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250702
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-07-02 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-03 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250703
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-07-03 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-04 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250704
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-07-04 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-05 00:00:00+00'::timestamptz);

CREATE TABLE convoy.delivery_attempts_tenant1_20250705
    PARTITION OF convoy.delivery_attempts
        FOR VALUES FROM ('tenant1', '2025-07-05 00:00:00+00'::timestamptz) TO ('tenant1', '2025-07-06 00:00:00+00'::timestamptz);
...
SELECT schemaname,
       ...
       (SELECT reltuples::BIGINT
        FROM pg_class
        WHERE oid =
              (quote_ident(schemaname) || '.' || quote_ident(tablename))::regclass)                     as estimated_rows
FROM pg_tables
...
-- ------------+------------------------------------+---------+----------------
--  convoy     | delivery_attempts                  | 0 bytes |           8000
--  convoy     | delivery_attempts_tenant1_20250601 | 160 kB  |            500
--  convoy     | delivery_attempts_tenant1_20250602 | 216 kB  |            800
--  convoy     | delivery_attempts_tenant1_20250626 | 160 kB  |            500
--  convoy     | delivery_attempts_tenant1_20250627 | 88 kB   |            200
--  convoy     | delivery_attempts_tenant1_20250628 | 120 kB  |            300
--  convoy     | delivery_attempts_tenant1_20250629 | 408 kB  |           1800
--  convoy     | delivery_attempts_tenant1_20250630 | 232 kB  |            950
--  convoy     | delivery_attempts_tenant1_20250701 | 64 kB   |            100
--  convoy     | delivery_attempts_tenant1_20250702 | 200 kB  |            750
--  convoy     | delivery_attempts_tenant1_20250703 | 176 kB  |            600
--  convoy     | delivery_attempts_tenant1_20250704 | 136 kB  |            400
--  convoy     | delivery_attempts_tenant1_20250705 | 264 kB  |           1100